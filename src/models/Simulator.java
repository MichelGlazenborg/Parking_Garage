...
public class Simulator {
    ...
    private int _paymentSpeed = 1; // number of cars that can pay per minute   (Global to make easily editable)
    private int _exitSpeed = 1;    // number of cars that can leave per minute (Global to make easily editable)
